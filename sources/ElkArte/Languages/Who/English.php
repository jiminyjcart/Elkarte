...
$txt['credits_contrib_list'] = 'For a complete list of the many individuals that contributed to the design and implementation of Elkarte, please refer to the official <a href="https://github.com/elkarte/Elkarte/graphs/contributors" target="_blank" class="new_win linkbutton">GitHub contributors.</a>';
...
$txt['credits_translators_message'] = 'Thank you for your efforts which make it possible for people all around the world to use ElkArte.  For a complete list please refer to the offical <a href="https://www.transifex.com/organization/elkarte/dashboard" target="_blank" class="new_win linkbutton">Transifex contributors.</a>';
